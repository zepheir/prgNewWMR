...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PA0 PA8 PA11 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_8|GPIO_PIN_11|GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Pin = GPRS_WORK_Pin|GPRS_NET_Pin|GPRS_LINKA_Pin|GPRS_LINKB_Pin;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = PWR_CHECK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PWR_CHECK_GPIO_Port, &GPIO_InitStruct);
